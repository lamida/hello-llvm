...
/home/lamida/github/llvm/llvm-project/llvm/cmake-build-release/bin/opt ../../$out_title.ll -passes=mycfg,dot-cfg
...
/home/lamida/github/llvm/llvm-project/llvm/cmake-build-release/bin/opt ../../$out_title.ll -passes=inliner-wrapper,mycfg,dot-cfg
ls *.dot | xargs -I{} dot -Tpng {} -o {}.png
# generate png for hidden files too
ls .*.dot | xargs -I{} dot -Tpng {} -o {}.png
cd ../..
